...
_PT_BR: dict[str, str] = {
    ...
    "win.hint.interfaces": "Selecione um ou mais adaptadores para testar em paralelo (ex.: Wi-Fi e "
                          "cabo ao mesmo tempo). Nenhum selecionado = deixar o SO escolher a rota (padrao).",
    "win.btn.refresh_interfaces": "Atualizar lista",
    "win.value.iface_unavailable_fmt": "{name} (nao detectada no momento)",
    ...
    "dlg.update_title": "Atualizacao disponivel",
    "dlg.update_available_fmt": "O PacketLizer {new} esta disponivel (voce tem {current}).",
    "dlg.update_notes_label": "Novidades:",
    "dlg.update_no_notes": "Sem notas de versao.",
    "dlg.update_chk_skip": "Nao lembrar de novo para esta versao",
    "dlg.update_btn_update": "Atualizar agora",
    "dlg.update_btn_later": "Depois",
    "dlg.update_downloading": "Baixando atualizacao... {pct}%",
    "dlg.update_failed": "Falha na atualizacao: {err}",
    "notify.update_restarting": "Atualizacao baixada. Reiniciando o PacketLizer...",
    ...
    "rpt.iface_heading_fmt": "Interface: {iface}",
    "rpt.unbound_iface": "Padrao (nenhuma interface selecionada)",
...
_ES: dict[str, str] = {
    ...
    "win.hint.interfaces": "Selecciona uno o mas adaptadores para probar en paralelo (p. ej. Wi-Fi y "
    ...
    "win.value.iface_status_fmt": "{name}: {state} (perdida {pct:.2f}%)",
    ...
    "dlg.update_title": "Actualizacion disponible",
    "dlg.update_available_fmt": "PacketLizer {new} esta disponible (tienes {current}).",
    "dlg.update_notes_label": "Novedades:",
    "dlg.update_no_notes": "Sin notas de la version.",
    "dlg.update_chk_skip": "No recordarme de nuevo para esta version",
    "dlg.update_btn_update": "Actualizar ahora",
    "dlg.update_btn_later": "Despues",
    "dlg.update_downloading": "Descargando actualizacion... {pct}%",
    "dlg.update_failed": "Fallo la actualizacion: {err}",
    "notify.update_restarting": "Actualizacion descargada. Reiniciando PacketLizer...",
